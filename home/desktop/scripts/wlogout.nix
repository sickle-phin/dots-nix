{ pkgs, ... }:
let
  # reference: https://github.com/JaKooLit/Hyprland-Dots/blob/main/config/hypr/scripts/Wlogout.sh
  wlogout-run = pkgs.writeShellScriptBin "wlogout-run" ''
    #!/usr/bin/env bash
