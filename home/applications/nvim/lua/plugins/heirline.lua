...
local Ruler = {
    { provider = "%02l:%02c", hl = { fg = "darker_black", bg = "cyan" } },
}
...
local TablineBufferBlock = {
    {
        ...
        hl = function(self)
            ...
            if self.bufnr == nrlist[1] then
                if self.is_active then
                    return { fg = "one_bg", bg = "NONE" }
                else
                    return { fg = "light_grey", bg = "NONE" }
                end
            elseif self.is_active then
                return { fg = "one_bg", bg = "one_bg3" }
            else
                return { fg = "light_grey", bg = "one_bg3" }
            end
        end,
    },
    {
        ...
        hl = function(self)
            ...
            if self.bufnr == nrlist[1] then
                if self.is_active then
                    ...
                    return { fg = "one_bg3", bg = "NONE" }
                end
            elseif self.is_active then
                return { fg = "one_bg", bg = "one_bg3" }
            else
                return { fg = "white", bg = "one_bg3" }
            end
        end,
    },
    {
    ...
    },
    {
        ...
        hl = function(self)
            ...
            elseif self.is_active then
                ...
                return { fg = "darker_black", bg = "one_bg3" }
            end
        end,
    },
}
...
local BufferLine = {
    utils.make_buflist({
        TablineBufferBlock,
    }, { provider = " ", hl = { fg = "one_bg" } }, { provider = " ", hl = { fg = "one_bg" } }),
}
...
local TabLineOffset = {
    ...
    {
        provider = "",
        hl = { fg = "one_bg", bold = true },
    },
    {
        hl = { bg = "one_bg", bold = true },
        {
            provider = " ",
        },
        {
            ...
            hl = { fg = "purple", bg = "one_bg", bold = true },
        },
        {
            provider = " ",
        },
...
Center = {
    hl = { bg = "one_bg" },
    { left,          hl = { fg = "one_bg", bg = "NONE" } },
    { provider = " " },
    { FileNameBlock },
    -- { HelpFileName },
    { provider = " " },
    { right,         hl = { fg = "one_bg", bg = "NONE" } },
}
...
FileEncoding = {
    {
        ...
        hl = function()
            if conditions.has_diagnostics() then
                return { fg = "pink", bg = "one_bg3" }
            else
                return { fg = "pink", bg = "NONE" }
            end
        end,
    },
    { provider = " " },
...
vim.api.nvim_create_autocmd("ColorScheme", {
    callback = function()
        utils.on_colorscheme(require("base46").theme_tables[theme].base_30)
    end,
    group = "Heirline",
})
